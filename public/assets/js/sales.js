        ...
        products.forEach(product => {
            ...
            html += `</div>
                        ...
                        <div class="border-t border-gray-200 pt-1 mt-2 bg-gray-50 rounded-lg px-4 py-1 flex justify-end">
                            <div class="text-xl font-[12px] text-gray-800"> Sub Total: ${subTotal}</div>
                        </div>  
                      
                      
                        <div class="border-t border-gray-200 pt-1 mt-2 bg-gray-50 rounded-lg px-4 py-1 flex justify-end">
                            <div class="text-xl font-[12px] text-gray-800"> Discount: ${product.discount}</div>
                        </div>   
                          <div class="border-t border-gray-200 pt-1 mt-2 bg-gray-50 rounded-lg px-4 py-1 flex justify-end">
                            <div class="text-xl font-[12px] text-gray-800"> Tax: ${product.tax}</div>
                        </div>
                        <div class="border-t border-gray-200 pt-1 mt-2 bg-gray-50 rounded-lg px-4 py-1 flex justify-end">
                            <div class="text-xl font-[12px] text-gray-800"> Shipping Charge: ${product.shippingCharge}</div>
                        </div>
