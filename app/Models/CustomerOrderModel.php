...
class CustomerOrderModel extends Model
{
    ...
    protected $allowedFields = ['user_id', 'order_number', 'gateway_order_id','tax','shipping_charge','discount', 'coupen_code_id','address_id','shipping_address', 'sub_total', 'total_amount', 'payment_method', 'payment_status', 'status', 'created_at'];
