...
class CouponcodeModel extends Model{
    ...
    protected $allowedFields = [ 'coupencode','coupenType','minimumShopping','discount','discount_type','is_active','maximum_discount_amount','validity_from','validity_to','created_at'];
