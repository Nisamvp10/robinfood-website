...
if(!$isLogin){
    ...
    if(count($data) > 0){
        ...
        foreach($data as $address){
           $html.= ' 
            <div class="card mt-2"><div class="card-body d-md-flex align-items-center gap-2"><input type="radio" name="address_id" onclick="isDefault(this)" style="width: 20px; margin-right: 10px;" class="mr-2  addressRadio" value="'.encryptor($address['id']).'" '.($address['is_default'] == 1 ? 'checked' : '').' >
